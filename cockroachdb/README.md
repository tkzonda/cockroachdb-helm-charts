...
```
my-release-cockroachdb-0    cockroachdb/cockroach:v22.1.4
my-release-cockroachdb-1    cockroachdb/cockroach:v22.1.4
my-release-cockroachdb-2    cockroachdb/cockroach:v22.1.4
my-release-cockroachdb-3    cockroachdb/cockroach:v22.1.4
```
...
Note that there are some backward-incompatible changes to SQL features between versions 20.2 and 21.1. For details, see the [CockroachDB v22.1.4 release notes](https://www.cockroachlabs.com/docs/releases/v22.1.4.html#backward-incompatible-changes).
...
| `image.tag`                                               | Container image tag                                                                                                                                                                                                                                                                                                                      | `v22.1.4`                                              |
...
| `statefulset.serviceAccount.annotations`                  | Additional annotations of service account                                                                                                                                                                                                                                                                                                | `{}`                                                   |
